    ...
    <div className={`min-h-screen bg-white ${inter.className}`}>
      ...
      <header className="flex justify-between items-center px-6 md:px-12 lg:px-16 py-5 w-full">
        ...
        <div className="flex items-center gap-6">
          <Link href="/auth/login" className="text-[15px] font-medium text-[#0A0A0A] hover:text-[#8A38F5] transition-colors">
            Login
          </Link>
          <Link href="/auth/register" className="bg-[#B597FF] hover:opacity-90 transition-opacity text-white text-[15px] font-medium px-5 py-2.5 rounded-lg shadow-sm">
            Sign Up
          </Link>
        </div>
      </header>
      ...
      <section 
        ...
        style={{ 
          backgroundImage: "url('/images%20homepage/Background%20homepage.webp')", 
        ...
        <div className="container mx-auto px-6 sm:px-16 py-16 flex flex-col md:flex-row items-center justify-between gap-12 relative z-10">
          ...
          <div className="md:w-[55%] flex flex-col items-start gap-5">
            ...
            <p className="text-[16px] leading-[1.6] text-[#717182] max-w-[420px] mt-2">
              AI-powered productivity assistant that understands your chaos, prioritizes your tasks, and creates schedules that actually work for you.
            </p>
            <div className="flex flex-wrap items-center gap-4 mt-6">
              ...
              >
                Try Demo
                <img src="/images%20homepage/Arrow.webp" alt="arrow" className="w-[18px] h-[18px] object-contain" />
              </Link>
              <Link 
                href="/auth/register" 
      ...
      <section className="bg-white py-24 px-6 sm:px-16 text-center flex flex-col items-center">
        <h2 className="text-[32px] sm:text-[36px] font-medium text-[#0A0A0A]">How It Works</h2>
        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl">
          ...
          <div className="bg-white p-8 sm:p-10 rounded-2xl shadow-[0_4px_25px_rgb(0,0,0,0.03)] border border-gray-100 flex flex-col items-start text-left hover:shadow-[0_8px_30px_rgb(0,0,0,0.06)] transition-all">
            <div className="mb-6 bg-purple-50 p-3 rounded-2xl inline-block">
               <img src="/images%20homepage/Dump%20Your%20Thoughts.webp" alt="Dump Thoughts" className="w-[32px] h-[32px] object-contain" />
            </div>
            <h3 className="text-[18px] font-semibold text-[#0A0A0A] mb-3">Dump Your Thoughts</h3>
          ...
          <div className="bg-white p-8 sm:p-10 rounded-2xl shadow-[0_4px_25px_rgb(0,0,0,0.03)] border border-gray-100 flex flex-col items-start text-left hover:shadow-[0_8px_30px_rgb(0,0,0,0.06)] transition-all">
            <div className="mb-6 bg-purple-50 p-3 rounded-2xl inline-block">
               <img src="/images%20homepage/AI%20Clarifies%20&%20Prioritizes.webp" alt="AI Clarifies" className="w-[32px] h-[32px] object-contain" />
            </div>
            <h3 className="text-[18px] font-semibold text-[#0A0A0A] mb-3">AI Clarifies & Prioritizes</h3>
            <p className="text-[15px] text-[#717182] leading-relaxed">
          ...
          <div className="bg-white p-8 sm:p-10 rounded-2xl shadow-[0_4px_25px_rgb(0,0,0,0.03)] border border-gray-100 flex flex-col items-start text-left hover:shadow-[0_8px_30px_rgb(0,0,0,0.06)] transition-all">
            <div className="mb-6 bg-purple-50 p-3 rounded-2xl inline-block">
              <img src="/images%20homepage/Get%20Your%20Schedule.webp" alt="Get Schedule" className="w-[32px] h-[32px] object-contain" />
            </div>
            <h3 className="text-[18px] font-semibold text-[#0A0A0A] mb-3">Get Your Schedule</h3>
            <p className="text-[15px] text-[#717182] leading-relaxed">
      ...
      <section className="bg-[#fafafa] sm:bg-transparent py-20 px-6 sm:px-16 text-center flex flex-col items-center">
        <h2 className="text-[28px] sm:text-[32px] font-medium text-[#0A0A0A]">Ready to Get Organized?</h2>
